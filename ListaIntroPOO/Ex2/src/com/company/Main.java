...
public class Main {
    ...
    public static void main(String[] args) {
            ...
            novaPessoa.nome = myObj.nextLine();
            novaPessoa.idade = myObj.nextInt();
            while (decisao == 1) {
                System.out.print("Quer que " + novaPessoa.nome + " faca aniversario? tecle 1 (sim) ou 2 (nao) \n");
                decisao = myObj.nextInt();
                if (decisao == 1){
                    novaPessoa.fazerAniversario();
                    System.out.print("A idade de " + novaPessoa.nome + "atual eh: " + novaPessoa.idade + "\n");
                }
                else if(decisao == 2){
