...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Construcao construcao1 = new Construcao(numeroPessoas, b1, numeroDeLampadas, b2);
        geradoresDeCarbono.add(construcao1);
        ...
        Construcao construcao2 = new Construcao(numeroPessoas2, b3, numeroDeLampadas2, b4);
        geradoresDeCarbono.add(construcao2);
        ...
        for(CarbonFootprint geradoreDeCarbono: geradoresDeCarbono){
            ...
            else if(geradoreDeCarbono.getClass() == Construcao.class){
                System.out.println("A medida de CarbonFootPrint desta construcao eh: " + geradoreDeCarbono.getCarbonFootPrint());
            }
        }
